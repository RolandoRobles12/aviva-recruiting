// Fallback question bank used when the `settings/psychometric_questions` doc
// hasn't been seeded yet (an admin never opened the "Banco de preguntas" tab).
// Kept in sync with src/services/psychometricQuestions.ts on the client.
